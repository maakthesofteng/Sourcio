...
const sourcioWallet = require('../../models/sourcioWallet')
...
const stripe = require("stripe")('sk_test_51Ql549P4bRH1g8X5Z20shHla6Gn5QRJBWzSDvQzexcrftD1NrE5LurrtCiovViYjUwuKAgDTUvEt5H7zebgwk0RA007lOmpN5f');
    ...
    try {
      ...
      for (let i = 0; i < products.length; i++) {
        ...
        authorOrderData.push({
          ...
          price: pri,
          payment_status: "unpaid",
          shippingInfo: "Sourcio Warehouse",
          delivery_status: "pending",
          date: tempDate
        });
      }
  ...
  get_customer_databorad_data = async (req, res) => {
    ...
    try {
      const recentOrders = await customerOrder
        .find({
          customerId: Types.ObjectId(userId),
        })
        .limit(5);
