...
export const get_active_sellers = createAsyncThunk(
    ...
    async ({ parPage, page, searchValue }, { rejectWithValue, fulfillWithValue, getState }) => {
        ...
        // }
        try {
            const { data } = await api.get(`/get-sellers?page=${page}&&searchValue=${searchValue}&&parPage=${parPage}`, {withCredentials: true}, /*config*/)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
...
export const get_deactive_sellers = createAsyncThunk(
    ...
    async ({ parPage, page, searchValue }, { rejectWithValue, fulfillWithValue, getState }) => {
        ...
        // }
        try {
            const { data } = await api.get(`/get-deactive-sellers?page=${page}&&searchValue=${searchValue}&&parPage=${parPage}`, {withCredentials : true}/*config*/)
            return fulfillWithValue(data)
        } catch (error) {
            return rejectWithValue(error.response.data)
        }
