...
const Headers = () => {
  ...
  return (
    <div className="w-full bg-white mb-5">
          ...
          <div className="flex w-full justify-between items-center h-[50px] text-slate-500">
            <ul className="flex justify-start items-center gap-8">
              <li className="flex relative justify-center items-center gap-2 text-sm after:absolute after:h-[18px] after:w-[1px] after:bg-[#afafaf] after:-right-[16px]">
                ...
                <span>info.sourcio@gmail.com</span>
              </li>
              <span>Sourcio</span>
            </ul>
            <div>
      ...
      <div className="w-white">
        <div className="max-w-[1440px] mx-auto px-16 sm:px-5 md-lg:px-12 md:px-10">
          <div className="h-[80px] md-lg:h-[100px] flex justify-between items-center flex-wrap">
            <div className="md-lg:w-full w-3/12 md-lg:pt-4 mt-3">
            ...
            <div className="md-lg:w-full w-9/12">
              <div className="flex justify-between md-lg:justify-center items-center flex-wrap pl-8">
                <ul className="flex justify-start items-start gap-8 text-sm font-bold uppercase md-lg:hidden">
                  ...
                  {/* <li>
                    <button
                      className="p-2 block text-slate-600 hover:text-[#7fad39] transition"
                  ...
                  {showChatIcon && (
                    <div className="fixed bottom-5 right-5 z-50">
                      <button
                        className="w-14 h-14 bg-blue-500 rounded-full flex justify-center items-center text-white shadow-xl"
          ...
          >
            <div className="flex justify-start flex-col gap-6">
              ...
              <ul className="flex flex-col justify-start items-start gap-3 text-[#1c1c1c]">
                ...
                <span className="text-sm">Sourcio</span>
              </ul>
            </div>
          </div>
        </div>
      ...
      {
        <div className="max-w-[1440px] mx-auto px-16 sm:px-5 md-lg:px-12 md:px-10 mt-5">
